...
public class LinearEquationLogic {
    ...
    public void start() {
        ...
        while (end = false) {
            ...
            System.out.println(more.coordinateForX(xVal));
            System.out.println("(o//w//o) <(Wanna go for another round? Answer with yay or nay!)");
    ...
    public boolean coordinateFormat(String coord) {
    ...
    public void getCoordinates1() {
        String temp1 = p1.substring(1, p2.indexOf(", "));
        String temp2 = p1.substring(p2.indexOf(", ") + 2, p2.indexOf(")"));
